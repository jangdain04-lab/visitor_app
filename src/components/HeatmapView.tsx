...
export function HeatmapView() {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      setZones((prev) => simulateDataUpdate(prev));
    }, 6500);
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top']}>
        ...
        <View style={[styles.mapArea, { height: mapHeight }]}>
          ...
          <View style={styles.mapControlGroup}>
            <TouchableOpacity
              ...
              onPress={() => setZones((prev) => simulateDataUpdate(prev))}
            >
              <Ionicons
                name="refresh"
                size={25 * scale}
      ...
      <ZoneDetailModal
        ...
        onRefresh={() => setZones((prev) => simulateDataUpdate(prev))}
      />
    </SafeAreaView>
  );
}
        ...
        <View style={styles.backdrop}>
          <View style={styles.reportSheet}>
            ...
            <TouchableOpacity
              ...
              style={[
                styles.sendButton,
                !choice && styles.sendButtonDisabled,
              ]}
